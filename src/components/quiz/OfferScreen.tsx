        ...
        <CardContent className="space-y-6 text-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                ...
                <div className="space-y-3">
                    ...
                    <Image src="https://i.imgur.com/d0efBEf.png" alt="Mulher insatisfeita" width={400} height={200} className="rounded-lg w-full" />
                ...
                <div className="space-y-3">
                    ...
                    <Image src="https://i.imgur.com/dn9wi1S.png" alt="Mulher satisfeita" width={400} height={200} className="rounded-lg w-full" />
                     <ul className="space-y-2">
