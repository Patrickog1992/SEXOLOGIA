            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-center">
                        <Image src="https://i.imgur.com/d0efBEf.png" alt="Mulher insatisfeita" width={300} height={200} className="rounded-lg mx-auto w-[300px] h-[200px] object-cover object-center" />
                    </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-center">
                        <Image src="https://i.imgur.com/dn9wi1S.png" alt="Mulher satisfeita" width={300} height={200} className="rounded-lg mx-auto w-[300px] h-[200px] object-cover object-top" />
                    </div>
                     <ul className="space-y-2">
